...
<a href="system/system.jsp?=home" target="_blank"><input id="logoutBtn" type="button" value="관리창"
style="width: 100%; height: 45px; background: rgb(69, 56, 40); color: #ddd; font-weight: bold; font-size: 1.1em; border-radius: 2px;"></a>
<%}else{%>
